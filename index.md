...
- [Paper](https://MooseOnDaLoose.github.io/pubtex/paper.pdf)
- [Slides](https://MooseOnDaLoose.github.io/pubtex/slides.pdf)
- [Handout](https://MooseOnDaLoose.github.io/pubtex/slides_handout.pdf)

## Usage

1. [Use this template](https://github.com/MooseOnDaLoose/pubtex/generate) (you only need to include the `main` branch)
